...
MODULES=(bootstrap tabs core/Registry services/EntityService services/VelocityService services/AimService services/SpoofService services/ResolverService modules/combat/InstantReload modules/combat/Aimbot modules/combat/FireBlink modules/combat/TargetStrafe modules/combat/Autofire modules/combat/TargetMelee modules/combat/TargetGun modules/visuals/ESP modules/tycoon/AutoBuy modules/tycoon/CrateFarm modules/tycoon/SoldierFarm modules/misc/ClientDesync modules/misc/About finalize)
mkdir -p "$ROOT/dist"
{
